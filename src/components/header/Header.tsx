      ...
      <div className={headerClass}>
        ...
        >
          <div className="flex lg:gap-5 gap-2 items-center mx-4 mt-3 cursor-default ">
            <Logo fill={`#ffff`} className="lg:w-20 w-10" />
          </div>
        </Link>
        ...
        <div className="lg:pl-[200px] flex gap-16">
          ...
          <button
            className="bg-green-500 text-white font-bold rounded-full pr-4 ml-2  items-center cursor-pointer hidden lg:flex"
            onClick={() => {
